...
import img from '../../../public/dashboard.jpg'
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        <h4 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-white">
          Packed with Unlimited features
        </h4>

        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-center font-normal text-neutral-300">
          From Advance Reseach to lead gen marketing automation exticute power workflows
        </p>
      </div>
      <div>
        <img src={img.src} alt="" />
...
export const SkeletonFour = () => {
  return (
    <div className="h-60 md:h-60  flex flex-col items-center relative bg-transparent bg-transparent mt-10">
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      onRender: (state: GlobeState) => {
        ...
        state.phi = phi;
        phi += 0.01;
        return state; // Important: return the updated state
      },
    });
