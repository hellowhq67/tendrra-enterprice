...
export function Footer() {
  return (
    <footer className="bg-black  border-t border-gray-800 w-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <h2 className="font-bold text-white text-xl">Tendrra</h2>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Empowering businesses and creators with AI-powered tools for social media, email marketing, content
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">123 AI Street, Tech Valley, CA 94103</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">info@ainexus.com</span>
              </li>
            </ul>
          </div>
        </div>
